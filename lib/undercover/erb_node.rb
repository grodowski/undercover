...
# Extensions to Imagen for parsing ERB templates via Undercover::ErbExtractor.
# The extractor produces a Ruby string with line positions preserved (newlines
# kept), which the parser gem can then parse into a proper AST with correct line
# numbers that map 1:1 back to the original ERB file.
#
...
module Undercover
  ...
  # Used when processing .erb files via Undercover::ErbExtractor output.
